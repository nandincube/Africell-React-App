...
app.delete("/products/:name", (req: Request, res: Response) => {
    if (data.find((item) => item.name !== req.params.name) === undefined) {
        res.sendStatus(404)
    }
